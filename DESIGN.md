...
- **Motion:** 150ms quick and 250ms standard transitions use a smooth ease-out. Arrows move slightly, navigation underlines grow, buttons compress on press, and FAQ text enters over 4px. The success check draws over 500ms with an 80ms delay. Reduced-motion preference removes animation and transitions and restores automatic scrolling. Pages do not depend on entrance animations.
